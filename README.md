...
Spring Boot demo with **Auth + Kafka + PostgreSQL** and a simple UI.

## Modules
- `backend` — Spring Boot app: auth (`/api/auth/register`, `/api/auth/login`), Kafka producer/consumer, PostgreSQL writes.
- `ui` — Front-end (ReactJS) for basic flows.
